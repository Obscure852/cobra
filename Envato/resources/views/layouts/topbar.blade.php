        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="{{ route('home') }}" class="logo logo-dark">
                    ...
                    <span class="logo-lg">
                        <img src="assets/images/logo-sm.svg" alt="" height="24"> <span class="logo-txt">Sultan</span>
                    </span>
                </a>
            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item bg-soft-light border-start border-end"
                    ...
                    <img class="rounded-circle header-profile-user"
                        src="@if (Auth::user()->profile_image != ''){{ URL::asset('images/users/' . Auth::user()->profile_image) }}@else{{ URL::asset('assets/images/users/avatar-1.jpg') }}@endif"
                        alt="Header Avatar">
                    <span class="d-none d-xl-inline-block ms-1 fw-medium">{{ Auth::user()->firstname ." ".Auth::user()->lastname }}</span>
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <a class="dropdown-item" href="{{ route('auth-lock-screen') }}"><i
