...
@section('title') {{ Auth::user()->firstname ."| Profile" }} @endsection
                        ...
                        <div class="d-flex align-items-start mt-3 mt-sm-0">
                            <div class="flex-shrink-0">
                                <div class="avatar-xl me-3">
                                    <img src="@if (Auth::user()->profile_image != ''){{ URL::asset('images/users/' . Auth::user()->profile_image) }}@else{{ URL::asset('assets/images/users/avatar-1.jpg') }}@endif" alt="User Profile Image" class="img-fluid rounded-circle d-block">
                                </div>
                            </div>
                            <div class="flex-grow-1">
                                <div>
                                    <h5 class="font-size-16 mb-1">{{ Auth::user()->firstname ." ". Auth::user()->lastname }}</h5>
                                    <p class="text-muted font-size-13">{{ Auth::user()->position }}</p>
